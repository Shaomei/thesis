...
Two major approaches in previous studies: first, tracing only specific keywords or URLs that known are related to protest\cite{}; second, tracing the flow of tweets by well-known activist users\cite{}. 

ZZZZZ: (TODO) add the mobilization time for the identified activist users (maybe in the mobilization part)!

Similarly to previous studies \cite{}{}, our first attempt is to have experts read through a sample of collected tweets and identify keywords or phrases associated with protest; during this process, our expert coders observed that most protest tweets contained with protest-related hashtags, such as $\#$Jan25 and $\#$Egypt. 
