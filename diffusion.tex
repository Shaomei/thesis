...
First, as most work focused on big cascades, the results can be biased towards the ``successful'' events that are deemed to be rare. Given the very high failing rate in social media, research\cite{Bakshy-2011} has shown that the capability of targeted ``influentials'' on generating large cascades is only marginally higher than the average; and their effect much less reliable than practioners had expected.
