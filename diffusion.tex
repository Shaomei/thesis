...
S-shape adoption curve and Bass model

epidemic models

threshold models

adoptation of WOM diffusion models (andrew's paper - scale-free, range of influence (anti-obesity work also mentioned))
